...
int main(void)
{
    ...
    printf("\n\nCPU @ %dHz\n", SystemCoreClock);
    printf("+------------------------------------------------------------------+ \n");
    printf("|    PDMA2 Memory to Memory Driver Sample Code (Stride_Repeat)      | \n");
    printf("+------------------------------------------------------------------+ \n");
    ...
    PDMA_SetTransferAddr(PDMA2,0, (uint32_t)au8SrcArray, PDMA_SAR_INC, (uint32_t)au8DestArray, PDMA_DAR_INC);
