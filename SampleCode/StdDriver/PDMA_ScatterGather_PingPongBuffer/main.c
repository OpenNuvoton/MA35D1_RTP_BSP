...
int main(void)
{
    ...
    printf("\n\nCPU @ %dHz\n", SystemCoreClock);
    printf("+-----------------------------------------------------------------------+ \n");
    printf("|         PDMA2 Driver Ping-Pong Buffer Sample Code (Scatter-gather)     | \n");
    printf("+-----------------------------------------------------------------------+ \n");
    ...
    PDMA_SetTransferMode(PDMA2,4, PDMA_MEM, TRUE, (uint32_t)&DMA_DESC[0]);
    ...
    /* Configure next descriptor table address */
    DMA_DESC[1].offset = (uint32_t)&DMA_DESC[0]; /* next operation table is table 1 */
